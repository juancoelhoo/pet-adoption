...
export class SequelizePostsRepository implements PostsRepository {
  async findAll(): Promise<Post[]> {
    try {
      const posts: PostModel[] = await PostModel.findAll({order: [['created_at', 'DESC']], include: {all: true}});
